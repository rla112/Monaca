...
public class ClassRoomServiceImpl implements ClassRoomService{
	...
	public ResponseDto<List<ClassRoomDto>> getAllClassRoom() {
		...
		classRoom.stream().forEach(data -> {
			...
			classRoomDto.setImage(data.getLecture().getImage());
			classRoomDto.setLectureName(data.getLecture().getLectureName());
			classRoomDto.setSubTitle(data.getLecture().getSubTitle());
			classRoomDto.setVideo(data.getLecture().getVideo());
			...
			classRoomDto.setLecture_id(data.getLecture().getId());
