      ...
      <Wrapper>
        ...
        <Section2>
            ...
            <MemoInner>
              <SubHeader>
                ...
                <SubText>
                  <ul>
                    <li>
                      메인페이지 하단에 회원등급안내도를 참고해주시길 바랍니다.
                    </li>
                    <li>
                      부정행위로 얻은 사탕 적발시 강제탈퇴조치 하겠습니다.
                    </li>
                    <li>
                      탈퇴조치 후에 재가입을 원하신다면 다시 회원가입을 하시면
                      됩니다.
                      <br /> 단, 회원등급이나 이전 계정에서 들었던 강의는 초기화
                      됩니다.
                    </li>
                    <li>
          ...
          <Bottom>
            ...
            <p>&#10230;</p>
            <BotButton>
              <Button onClick={navigateToMessage}>관리자에게 쪽지 쓰기</Button>
            </BotButton>
          </Bottom>
        </Section2>
      </Wrapper>
